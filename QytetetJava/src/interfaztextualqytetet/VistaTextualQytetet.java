...
public class VistaTextualQytetet {
    ...
    //eleccion de metodo para salir de la carcel. Por completar
        ...
        menuSC.put(0, "Tirar el dado");
        menuSC.put(1, "Pagar libertad");
    ...
    // se pide si o no se quiere comprar una propiedad. Por completar
        ...
        Map<Integer, String> menuEQC = new TreeMap();
        menuEQC.put(0, "Comprar");
        menuEQC.put(1, "No comprar");
        int salida=this.seleccionMenu(menuEQC); // Método para controlar la elección correcta en el menú 
        if (salida == 0)
            compra = true;
        return compra;
    }
